<nav class="navbar bg-slate-800 dark:bg-gray-900" id="navbar">
    <div class="container flex flex-wrap items-center justify-between">
        ...
        <div class="navigation lg_992:order-1 lg_992:flex hidden" id="menu-collapse">
            <ul class="navbar-nav nav-light" id="navbar-navlist">
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('home')}}">{{ trans('landing.home') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('home')}}#about">{{ trans('landing.about_us') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('home')}}#features">{{ trans('landing.our_services') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('home')}}#portfolio">{{ trans('landing.portfolio') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('home')}}#testi">{{ trans('landing.testimonials') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('home')}}#contact">{{ trans('landing.contact_us') }}</a>
                </li>     
