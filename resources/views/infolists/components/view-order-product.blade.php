            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
             ...
             @if($getRecord()->products()->get())
              ...
              <tr>
                ...
                <td class="p-4 text-right text-base font-bold text-gray-900 dark:text-white">{{$getRecord()->currency->symbol}} {{$product->expected_price}}</td>
              </tr>
              @endforeach
              @endif
          ...
          <div class="space-y-4">
            <div class="space-y-2">
              <dl class="flex items-center justify-between gap-4">
                ...
                <dd class="text-base font-medium text-gray-900 dark:text-white">{{$getRecord()->currency->symbol}} {{$total}}</dd>
              </dl>
              {{-- <dl class="flex items-center justify-between gap-4">
