    ...
    <section class="pb-16">
        <div class="container mx-auto">
            <div class="mb-10 flex gap-x-2 text-sm font-semibold">
                <a href="{{ route('filamentblog.post.index') }}" class="opacity-60">الرئيسية</a>
                <span class="opacity-30">/</span>
                <a href="{{ route('filamentblog.post.all') }}" class="opacity-60">المدونة</a>
                <span class="opacity-30">/</span>
                    ...
                    <div class="py-5">
                        <div class="sticky top-24 flex flex-col items-center gap-y-5 divide-y-2">
                            <button x-data="" x-on:click="document.getElementById('comments').scrollIntoView({ behavior: 'smooth'})" class="group/btn flex flex-col items-center justify-center gap-y-2">
                                ...
                                <span class="text-xs font-semibold">التعليقات</span>
                            </button>
                            <div class="pt-5">
                    ...
                    <div class="space-y-10">
                        <div>
                            <div class="flex flex-col justify-end">
                                <div class="mb-6 w-full h-[500px] overflow-hidden rounded bg-slate-200">
                                    <img class="flex h-full w-full  items-center justify-center object-cover object-top text-sm text-xl font-semibold text-slate-400" src="{{ $post->featurePhoto  }}" alt="{{ $post->photo_alt_text }}">
                                </div>
                                <div class="mb-6">
                        ...
                        <div class="border-t-2 py-10">
                            <div class="mb-4">
                                <h3 class="mb-2 text-2xl font-semibold">التعليقات</h3>
                            </div>
                ...
                <div>
                    <div class="relative mb-6 flex items-center gap-x-8">
                        <h2 class="whitespace-nowrap text-xl font-semibold">
                            <span class="text-primary font-bold">#</span> مواضيع مشابهة
                        </h2>
                    ...
                    <div class="grid md:grid-cols-3 sm:grid-cols-1 gap-x-12 gap-y-10">
                        ...
                        <div class="col-span-3">
                            <p class="text-center text-xl font-semibold text-gray-300">لايوجد مواضيع مشابهة</p>
                        </div>
                        @endforelse
                    </div>
